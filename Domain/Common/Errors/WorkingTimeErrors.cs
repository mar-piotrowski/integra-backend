...
public static class WorkingTimeErrors {
    ...
    public static Error NotFoundForStats => new Error(HttpStatusCode.NotFound, "",
        "Nie znaleziono czasów pracy z podanymi danymi do statystyki");
    ...
    public static Error WrongMonth => new Error(HttpStatusCode.BadRequest, " ", "Podano bledy miesiac");
}