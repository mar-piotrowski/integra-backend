...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240101153427_inisdfdsfstsdf")]
    partial class inisdfdsfstsdf
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.ContractChange", b =>
                {
                    b.HasOne("Domain.Entities.Contract", "ContractChanged")
                        .WithOne("ContractChange")
                        .HasForeignKey("Domain.Entities.ContractChange", "ContractChangeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_contract_changes_contracts_contract_changed_temp_id");
                    ...
                    b.OwnsMany("Domain.ValueObjects.ModulePermission", "ModulePermissions", b1 =>
                        {
                            ...
                            b1.WithOwner()
                                ...
                                .HasConstraintName("fk_module_permission_credentials_credential_temp_id");
                        });
                    ...
                    b.OwnsMany("Domain.ValueObjects.Permission", "Permissions", b1 =>
                        {
                            ...
                            b1.WithOwner()
                                .HasForeignKey("CredentialId")
                                .HasConstraintName("fk_permission_credentials_credential_temp_id1");
                        });
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    b.HasOne("Domain.Entities.Credential", "Credential")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_users_credentials_credential_temp_id2");
