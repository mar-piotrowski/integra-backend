...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231201003316_fsoktawsdfsa")]
    partial class fsoktawsdfsa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.HolidayLimit", b =>
                {
                    b.HasOne("Domain.Entities.User", "User")
                        .WithOne("HolidayLimit")
                        .HasForeignKey("Domain.Entities.HolidayLimit", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_holiday_limits_users_user_id");
