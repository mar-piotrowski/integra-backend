...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240104205311_sdfdsf")]
            ...
            modelBuilder.Entity("Domain.Entities.ContractChange", b =>
                {
                    b.HasOne("Domain.Entities.Contract", "ContractChanged")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_contract_changes_contracts_contract_changed_temp_id1");
                    ...
                    b.HasOne("Domain.Entities.Contract", "Contract")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_contract_changes_contracts_contract_temp_id");
            ...
            modelBuilder.Entity("Domain.Entities.SchoolHistory", b =>
                {
                    b.HasOne("Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_school_histories_users_user_temp_id6");
